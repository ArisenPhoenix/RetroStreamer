...
inline void write_controller_info(Writer& writer, const ControllerInfo& controller) {
...
inline ControllerInfo read_controller_info(Reader& reader) {
...
inline void write_controller_infos(Writer& writer, const std::vector<ControllerInfo>& controllers) {
...
inline std::vector<ControllerInfo> read_controller_infos(Reader& reader) {
...
inline ByteBuffer serialize_payload(const GameListRequest& payload) {
    Writer writer;
    writer.write_pod<std::uint64_t>(payload.client_catalog_revision);
    return writer.take();
}

inline ByteBuffer serialize_payload(const GameList& payload) {
...
inline ByteBuffer serialize_payload(const ActiveSessionInfoRequest&) {
    return {};
}

inline ByteBuffer serialize_payload(const ActiveSessionInfo& payload) {
    Writer writer;
...
inline ByteBuffer serialize_payload(const SessionReady& payload) {
    Writer writer;
...
inline ByteBuffer serialize_payload(const SessionStarting& payload) {
    Writer writer;
    writer.write_string(payload.selected_game_id);
    writer.write_pod<GameSessionMode>(payload.session_mode);
    writer.write_pod<std::uint8_t>(payload.player_count);
...
inline ByteBuffer serialize_payload(const SessionEnded& payload) {
    Writer writer;
    writer.write_string(payload.reason);
    return writer.take();
}

inline ByteBuffer serialize_payload(const MediaEndpoint& payload) {
    Writer writer;
...
inline PacketType packet_type_for(const GameListRequest&) { return PacketType::GameListRequest; }
inline PacketType packet_type_for(const GameList&) { return PacketType::GameList; }
inline PacketType packet_type_for(const ActiveSessionInfoRequest&) { return PacketType::ActiveSessionInfoRequest; }
inline PacketType packet_type_for(const ActiveSessionInfo&) { return PacketType::ActiveSessionInfo; }
inline PacketType packet_type_for(const SessionReady&) { return PacketType::SessionReady; }
inline PacketType packet_type_for(const SessionStarting&) { return PacketType::SessionStarting; }
inline PacketType packet_type_for(const SessionEnded&) { return PacketType::SessionEnded; }
inline PacketType packet_type_for(const MediaEndpoint&) { return PacketType::MediaEndpoint; }
...
inline GameListRequest read_game_list_request(Reader& reader) {
    return GameListRequest{reader.read_pod<std::uint64_t>()};
}

inline GameList read_game_list(Reader& reader) {
    GameList payload;
...
inline ActiveSessionInfoRequest read_active_session_info_request(Reader&) {
    return ActiveSessionInfoRequest{};
}

inline ActiveSessionInfo read_active_session_info(Reader& reader) {
...
inline SessionReady read_session_ready(Reader& reader) {
    return SessionReady{
        reader.read_string(),
        reader.read_pod<GameSessionMode>(),
        reader.read_pod<std::uint8_t>(),
...
inline SessionStarting read_session_starting(Reader& reader) {
...
inline SessionEnded read_session_ended(Reader& reader) {
    return SessionEnded{reader.read_string()};
}

inline MediaEndpoint read_media_endpoint(Reader& reader) {
